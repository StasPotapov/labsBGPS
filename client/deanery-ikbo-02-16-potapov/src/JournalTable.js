                ...
                return <tr key={student.id}>
                    ...
                    <td>{student.surname} {student.name} {student.last_name}</td>
                        {this.props.subjects.map((subj, i) => {
                            return student.marks[subj.index] ? <td key={student.id + "-" + subj.index} style = {student.marks[subj.index].mark_id == 4 || student.marks[subj.index].mark_id == 6? {background:'#ff4242'} : {}}>
